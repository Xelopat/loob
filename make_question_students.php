...
?>
<br/>
<font  align="center" size=6 class="question" style="font-weight:bold">Считаете ли Вы, что педагог обеспечивает подготовку, достаточную для успешной работы, учебы?</font><br/>
<input type="radio" name="1" value="5"required /> <font  align="center" size=4 class="question">5) считаю, что педагог обеспечивает достаточную подготовку моему ребенку;</font><br /> 
...
<br/>
<font  align="center" size=6 class="question" style="font-weight:bold">Чувствуете ли Вы на себе влияние педагога?</font><br/>
<input type="radio" name="2" value="5"required /><font  align="center" size=4 class="question">5) да, влияние положительное и систематическое;</font><br/>
...
<input type="radio" name="3" value="5"required /><font  align="center" size=4 class="question">5) постоянно стремится к установлению доброжелательных отношений с моим ребенком;</font><br/>
...
<input type="radio" name="4" value="5"required /><font  align="center" size=4 class="question">5) считаю, что моему ребенку повезло с педагогом;</font><br/>
...
<br/>
<font  align="center" size=6 class="question" style="font-weight:bold">Считаете ли Вы, что педагог видит и учитывает Ваши индивидуальные особенности? </font><br/>
<input type="radio" name="5" value="5"required /><font  align="center" size=4 class="question">5) всегда учитывает индивидуальные особенности моего ребенка;</font><br/>
...
<br/>
<font  align="center" size=6 class="question" style="font-weight:bold">Всегда ли педагог тактичен, корректен по отношению к Вам?</font><br/>
<input type="radio" name="6" value="5"required /><font  align="center" size=4 class="question">5) всегда тактичен и корректен;</font><br/>
...
<br/>
<font  align="center" size=6 class="question" style="font-weight:bold">Удовлетворяет ли Вас то, что Вы занимаетесь у данного педагога?</font><br/>
<input type="radio" name="7" value="5"required /><font  align="center" size=4 class="question">5) удовлетворен тем, что мой ребенок занимается у данного педагога;</font><br/>
...
<br/>
<font  align="center" size=6 class="question" style="font-weight:bold">Какое влияние, по Вашему мнению, оказывает посещение уроков у данного педагога на Вас?</font><br/>
<input type="radio" name="8" value="5"required /><font  align="center" size=4 class="question">5) вызывает интерес, развивает любознательность;</font><br/>
...
<input type="radio" name="9" value="5"required /><font  align="center" size=4 class="question">5) да, всегда;</font><br/>
...
<input type="radio" name="10" value="5"required /><font  align="center" size=4 class="question">5) да, вполне;</font><br/>
...
<br/>
<font  align="center" size=6 class="question" style="font-weight:bold">Какова, по вашему мнению, роль педагога в преодолении трудностей, возникающих у Вас в процессе его обучения?</font><br/>
<input type="radio" name="11" value="5"required /><font  align="center" size=4 class="question">5) педагог постоянно следит за динамикой обучения ребенка и оказывает своевременную коррекцию;</font><br/>
...
<br/>
<font  align="center" size=6 class="question" style="font-weight:bold">Привлекает ли педагог Вас к различным видам внеурочной деятельности?</font><br/>
<input type="radio" name="12" value="5"required /><font  align="center" size=4 class="question">5) достаточно часто привлекает к различным видам внеурочной деятельности;</font><br/>
...
<input type="radio" name="13" value="5"required /><font  align="center" size=4 class="question">5) характер взаимоотношений с педагогом меня вполне устраивает;</font><br/>
...
<input type="radio" name="14" value="5"required /><font  align="center" size=4 class="question">5) да, всегда проявляет инициативу;</font><br/>
...
<br/>
<font  align="center" size=6 class="question" style="font-weight:bold">Помогает ли Вам педагог в решении проблем, возникающих у Вас во внеурочной деятельности?</font><br/>
<input type="radio" name="15" value="5"required /><font  align="center" size=4 class="question">5) да, всегда помогает;</font><br/>
